...
public class FloatingTextManager : MonoBehaviour
{
    ...
    public GameObject textPrefab;                   //UI 텍스트 프리펩
    ...
    public void Show(string text, Vector3 worldPos)
    {
        ...
        GameObject textObj = Instantiate(textPrefab.gameObject, transform); //UI텍스트 생성
    ...
    private IEnumerator AnimateText(GameObject textObj)
    {
        ...
        Vector3 startPos = textObj.transform.position;  
            TextMeshProUGUI temp = textObj.GetComponent<TextMeshProUGUI>();     //받아온 오브젝트에서 TMP폰트 참조
